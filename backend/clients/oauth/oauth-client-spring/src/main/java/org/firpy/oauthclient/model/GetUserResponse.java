...
public class GetUserResponse {
  ...
  public GetUserResponse enabled(Boolean enabled) {
  ...
  public GetUserResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, getUserResponse.email) &&
        Objects.equals(this.firstName, getUserResponse.firstName) &&
        Objects.equals(this.lastName, getUserResponse.lastName) &&
        Objects.equals(this.enabled, getUserResponse.enabled) &&
        Objects.equals(this.id, getUserResponse.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, enabled, id);
  }
